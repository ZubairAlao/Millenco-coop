        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className='grid grid-cols-1 gap-3'>
              ...
              <p className='bg-[#C8E6C9] dark:bg-[#37474F] p-4 m-auto w-full rounded-md'><span className="font-bold">Balance:</span> ₦{data.accountBalance && data.accountBalance.toLocaleString()}</p>
              <p className='bg-[#C8E6C9] dark:bg-[#37474F] p-4 m-auto w-full rounded-md'><span className="font-bold">Loan Payment:</span>₦{data.loanPayment && data.loanPayment.toLocaleString()} {data.loanRepayPerMonth > 0 ? <span className="font-bold block">Per Month ₦{data.loanRepayPerMonth.toLocaleString()}</span> : null}</p>
            </div>
